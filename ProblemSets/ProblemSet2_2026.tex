...
%   
  One annoying feature of \emph{merge sort} is that it ignores long
  runs of already sorted elements.  Your task in this problem is to
  analyse a modified algorithm by Jakob
  % that changes this.
