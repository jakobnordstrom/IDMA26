...
\end{tikzpicture}
  %
  \caption{Breadth-first-search tree for graph traversal in
    Problem~\ref{problem:traversal}
    with (directed) edges in spanning tree in red.
  }
  \label{fig:bfs-new}  
\end{figure}
