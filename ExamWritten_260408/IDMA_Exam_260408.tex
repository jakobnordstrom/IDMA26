...
%%%
  ...
  subset of $[n + r - 1]$ of size $n-1$ by running the following piece
  of code (which assumes that the elements in the multiset are sorted
  in increasing order): 
\begin{verbatim}
PSEUDO-CODE HERE
\end{verbatim}
...
\end{solution}
  ...
  \begin{subproblem}%
    ...
    {\ignorespaces}
%%%
    Is Jakob's new algorithm correct? Can you prove that the
...
\end{solution}
  ...
  \begin{subproblem}%
    ...
    not. For each property, you get points for a  correct
