...
\section*{Supplerende læsning}

Ud over
\emph{``Some notes on graphs in Danish''}
har vi også slides på dansk om det meste af det gennemgåede materiale,
som er udarbejdet af mine kolleger i Algorithms and Complexity
Section.
Alt kan findes i denne uges modul på Absalon.
