...
\textit{This week the lectures will be given by Jakob Nordström's
  colleague Amir Yehudayoff, also from the Algorithms and Complexity
  Section at DIKU.
}
...
separate course on linear algebra, but for
some of you this linear algebra course might come after IDMA
(or else it might be helpful with a refresher). 
%   many (or all) of you it
%   comes after this course, and so cannot help us with the material we
%   need.
Therefore, just to make sure we are on the same page, we will
