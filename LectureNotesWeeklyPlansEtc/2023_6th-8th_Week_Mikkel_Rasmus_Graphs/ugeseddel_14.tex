...
\begin{itemize}
\item[-] \emph{\href{https://absalon.ku.dk/courses/60107/files/6656269}{Noter om grafer}} (alt indhold bortset fra dybde-først søgning dækkes i denne uge)
...
\begin{itemize}
\item[-]
Mandag: Repræsentation af grafer (Noter om grafer / CLRS~20.1), bredde-først søgning (Noter om grafer / CLRS~20.2)

\item[-]
Tirsdag: Korteste vej, Dijkstra's algoritme (Noter om grafer / CLRS 22.0, 22.3)
