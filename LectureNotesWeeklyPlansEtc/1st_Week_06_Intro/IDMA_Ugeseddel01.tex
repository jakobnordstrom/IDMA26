...
% Dates
\newcommand{\mondaylecturedate}{Monday Feb 2\xspace}
\newcommand{\wednesdaylecturedate}{Wednesday Feb 4\xspace}
\newcommand{\deadlinefirstpset}{%
  \sout{Wednesday Feb 11}
  Monday Feb 16
  at 12:59 CET\xspace}
...
The reading material for this week includes:
\begin{itemize}
\item
  Cormen, Leiserson, Rivest, and Stein (CLRS): Chapters 1--3 and 10.
  
\item
  Notes no functions and asymptotic analysis.
  
\item
  Some slides (in Danish) on stacks, queues, and (linked) lists.
  
\item
  And all of the lecturers handwritten notes, if they are helpful for you.
  (Typically, the handwritten lecture notes will cover slightly more than
  what is actually said in class.)
  
\end{itemize}
%
Note that all the material is collected in a module for this week
on the Absalon course pages.
...
%       $16$
    $9$
    in this array and for element $18$.
...
\item
  ...
  \item
    Run selection sort 
    (the sorting algorithm mentioned in CLRS \mbox{exercise 2.2-2})
    on this array and illustrate iteration by iteration how the
    array gets sorted.
