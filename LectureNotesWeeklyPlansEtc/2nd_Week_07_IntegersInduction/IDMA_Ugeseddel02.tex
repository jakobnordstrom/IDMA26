...
% Dates
\newcommand{\mondaylecturedate}{Monday Feb 9\xspace}
\newcommand{\wednesdaylecturedate}{Wednesday Feb 11\xspace}
...
we will encounter for the first time
...
%%% Adjusted planning for induction
...
\item
  \textbf{Some Notes on Mathematical Induction:}
