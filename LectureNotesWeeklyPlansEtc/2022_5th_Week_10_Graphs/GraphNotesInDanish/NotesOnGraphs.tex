...
med en nabomatrix\footnote{Somme tider bruges ``incidens'' på dansk fejlagtigt i stedet for ``nabo'', men det betyder noget andet.} $A$ (eng: \bfs{adjacency matrix}), hvor indgangen
