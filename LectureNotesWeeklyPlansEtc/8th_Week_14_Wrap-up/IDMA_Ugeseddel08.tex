...
As the final topic in the course curriculum, we will study how to compute shortest paths in graphs as in CLRS Chapter~22.

If we do not quite manage to finish that topic during the next to last
lecture, we might use some time for this on the final lecture also.
Otherwise, the last lecture is intended as a 
question-and-answer session
(to be followed by a final exercise session with your TAs).
...
(and, of course, to
\textbf{hand in the final problem set in time, so that
you are sure to be eligible for the exam}).


\mbox{ } \\
\noindent
I hope this has been a challenging but
also enjoyable course for you, 
and that you have been able to learn useful stuff.
\textbf{\textit{Good luck on the exam!}}
